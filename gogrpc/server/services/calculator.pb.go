...
type HelloRequest struct {
	...
	Name        string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // 1 คือ tag
...
type HelloResponse struct {
	...
	Result string `protobuf:"bytes,1,opt,name=result,proto3" json:"result,omitempty"` // 1 คือ tag
}
